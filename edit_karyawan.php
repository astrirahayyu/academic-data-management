...
include_once 'koneksi_db.php';
  ...
  if (isset($_POST['Update'])){
    ...
    $result = mysqli_query($connection,"UPDATE karyawan SET nk='$nk', nama='$nama',alamat='$alamat', jabatan='$jabatan',WHERE nk='$nk'");
  ...
  $karyawan = mysqli_query($connection, "SELECT * FROM karyawan WHERE nk='$nk'");

  while ($data_karyawan = mysqli_fetch_array($karyawan)){
    $nrp = $data_karyawan['nk'];
...
<nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
  ...
  <section class="page-section" id="add-user">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Edit Karyawan</h2>
          ...
          <form action="edit_karyawan.php" method="post">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NK</label>
                <input class="form-control" id="nk" name="nk" type="text" value='<?php echo $nk; ?>' required="required">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Jabatan</label>
                <input class="form-control" id="jabatan" name="jabatan" type="text" value='<?php echo $jabatan; ?>' required="require">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
            ...
            <div class="form-group">
              <input type="hidden" name="nk" value='<?php echo $_GET['nk']; ?>'>
