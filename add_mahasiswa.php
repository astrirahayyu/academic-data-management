...
<?php
  ...
  $program_studi = mysqli_query($connection, "SELECT * FROM program_studi ORDER BY id_program_studi ");
  ...
  if (isset($_POST['Submit'])){
    ...
    $jenis_kelamin = $_POST['jenis_kelamin'];
  	...
  	$data = mysqli_query($connection, "INSERT INTO mahasiswa(nrp,nama,kelas,alamat,tanggal_lahir,id_program_studi, jenis_kelamin) VALUES ('$nrp','$nama','$kelas','$alamat','$tanggal_lahir','$id_program_studi','$jenis_kelamin')");
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mahasiswa.php" method="post" novalidate="novalidate">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Kelas</label>
                <input class="form-control" id="kelas" name="kelas" type="text" placeholder="masukkan kelas" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>alamat</label>
                <input class="form-control" id="alamat" name="alamat" type="text" placeholder="masukkan alamat" required="require">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <div>
                ...
                <select name="id_program_studi" class="form-control">
                  ...
                  <?php
                  while($data_prodi = mysqli_fetch_array($program_studi))
                  {
                    echo "<option value=".$data_prodi['id_program_studi'].">".$data_prodi ['nama_program_studi']."</option>";
                  }
                  ?>
                </select>
                <p class="help-block text-danger"></p>
