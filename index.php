...
<body id="page-top">
  ...
  $karyawan = mysqli_query($connection, "SELECT * FROM karyawan ORDER BY nk");
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
            ...
            <center><img class="img-fluid" src="img/education.png" alt="">
            </center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
            ...
            <center><img class="img-fluid" src="img/staff.png" alt="">
            </center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <center><img class="img-fluid" src="img/document.png" alt="">
            </center>
          </div>
        </div>
                ...
                <!-- Portfolio Modal - Text -->
                 <div>
                  ...
                  while ($data_mahasiswa = mysqli_fetch_array($mahasiswa)) {
                    ...
                    echo "<td>".$data_mahasiswa['kelas']."</td>";
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <div>
                  ...
                  <?php
                  $no = 1;
                  while ($data_karyawan = mysqli_fetch_array($karyawan)) {
                    echo "<tr>";
                    echo "<td>".$no++. "</td>";
                    echo "<td>".$data_karyawan['nk']."</td>";
                    echo "<td>".$data_karyawan['nama']."</td>";
                    echo "<td>".$data_karyawan['jeniskelamin']."</td>";
                    echo "<td>".$data_karyawan['notlp']."</td>";
                    echo "<td>".$data_karyawan['alamat']."</td>";
                    echo "<td>".$data_karyawan['jabatan']."</td>";
                    echo "<td>
                    <a class= 'btn btn-success' href='edit_mahasiswa.php?nrp=$data_mahasiswa[nk]'>Edit</a> 
                   <a class= 'btn btn-danger' href='delete_mahasiswa.php?nrp=$data_mahasiswa[nk]'><i class 'fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                  }
                  ?>
                </tbody>
              </table>
