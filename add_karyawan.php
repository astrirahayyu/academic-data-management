...
include_once 'koneksi_db.php';
  ...
  if (isset($_POST['Submit'])){
    ...
    $notlp = $_POST['notlp'];
  	...
  	$data = mysqli_query($connection, "INSERT INTO (nk,nama,jeniskelamin,notlp,alamat,jabatan) karyawan VALUES ('$nk','$nama','$jeniskelamin','$notlp',$alamat','$jabatan')");
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_karyawan.php" method="post" novalidate="novalidate">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NK</label>
                <input class="form-control" id="nk" name="nk" type="text" placeholder="masukkan nk" required="required">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>notlp</label>
                <input class="form-control" id="notlp" name="notlp" type="text" placeholder="masukkan no tlp" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Jabatan</label>
                <input class="form-control" id="jabatan" name="jabatan" type="text" placeholder="masukkan jabatan" required="require">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
